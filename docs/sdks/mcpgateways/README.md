...
with Orq(
    ...
    res = orq.mcp_gateways.create(key="<key>", display_name="Litzy_Ruecker98", server_links=[
        {
            "mcp_server_id": "<id>",
            "alias": "<value>",
            "tool_exposure": {
...
| `display_name`                                                                                                                           | *str*                                                                                                                                    | :heavy_check_mark:                                                                                                                       | Human readable name shown in the workspace.                                                                                              | Production Gateway                                                                                                                       |
...
with Orq(
    ...
    res = orq.mcp_gateways.update(id="<id>", server_links=[
        {
            "mcp_server_id": "<id>",
            "alias": "<value>",
            "tool_exposure": {
