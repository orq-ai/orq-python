...
with Orq(
    ...
    res = orq.notifiers.update(notifier_id="<id>", type_="NOTIFIER_TYPE_SLACK_WEBHOOK")
...
| `type`                                                                                                                                                                                          | [Optional[models.NotifierType]](../../models/notifiertype.md)                                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                              | N/A                                                                                                                                                                                             | NOTIFIER_TYPE_SLACK_WEBHOOK                                                                                                                                                                     |
