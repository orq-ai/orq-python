...
| `identity`                                                                                                                                                                                                   | [Optional[models.CreateAgentResponseRequestIdentity]](../../models/createagentresponserequestidentity.md)                                                                                                    | :heavy_minus_sign:                                                                                                                                                                                           | Information about the identity making the request. If the identity does not exist, it will be created automatically.                                                                                         |
