...
### `models.CreateEvalGuardrailConfigEvalsResponse200ApplicationJSONResponseBody7Categorical`

```python
value: models.CreateEvalGuardrailConfigEvalsResponse200ApplicationJSONResponseBody7Categorical = /* values here */
```
