...
| `parts`                                                                                | List[[models.InvokeAgentPublicMessagePart](../models/invokeagentpublicmessagepart.md)] | :heavy_check_mark:                                                                     | A2A message parts (text, file, or tool_result only)                                    |