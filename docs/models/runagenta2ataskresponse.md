...
| `kind`                                                                       | [models.RunAgentKind](../models/runagentkind.md)                             | :heavy_check_mark:                                                           | A2A entity type identifier                                                   |
| `status`                                                                     | [models.RunAgentTaskStatus](../models/runagenttaskstatus.md)                 | :heavy_check_mark:                                                           | Current task status information                                              |
