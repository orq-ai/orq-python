...
### `models.GetEvalsGuardrailConfigEvalsResponse200ApplicationJSONResponseBodyCategorical`

```python
value: models.GetEvalsGuardrailConfigEvalsResponse200ApplicationJSONResponseBodyCategorical = /* values here */
```
