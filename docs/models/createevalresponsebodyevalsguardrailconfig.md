...
### `models.CreateEvalGuardrailConfigEvalsResponse200ApplicationJSONCategorical`

```python
value: models.CreateEvalGuardrailConfigEvalsResponse200ApplicationJSONCategorical = /* values here */
```
