...
### `models.AgentToolInputCRUDJSONSchemaTool`

```python
value: models.AgentToolInputCRUDJSONSchemaTool = /* values here */
```

### `models.AgentToolInputCRUDMCPTool`

```python
value: models.AgentToolInputCRUDMCPTool = /* values here */
```

### `models.AgentToolInputCRUDProviderBuiltInTool`

```python
value: models.AgentToolInputCRUDProviderBuiltInTool = /* values here */
```
