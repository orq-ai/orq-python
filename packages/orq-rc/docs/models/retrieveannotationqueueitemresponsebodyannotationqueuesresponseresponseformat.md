...
```python
from orq_ai_sdk.models import RetrieveAnnotationQueueItemResponseBodyAnnotationQueuesResponseResponseFormat
value: RetrieveAnnotationQueueItemResponseBodyAnnotationQueuesResponseResponseFormat = "mp3"
```
