...
| `format_`                                                                                              | [models.ModelConfigurationFormat](../models/modelconfigurationformat.md)                               | :heavy_check_mark:                                                                                     | Specifies the output audio format. Must be one of wav, mp3, flac, opus, or pcm16.                      |