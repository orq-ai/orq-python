...
with Orq(
    ...
    res = orq.api_keys.create(name="<value>", permission_mode="PERMISSION_MODE_ALL")
...
| `permission_mode`                                                                                                                                                                                                                                          | [models.PermissionMode](../../models/permissionmode.md)                                                                                                                                                                                                    | :heavy_check_mark:                                                                                                                                                                                                                                         | N/A                                                                                                                                                                                                                                                        |
