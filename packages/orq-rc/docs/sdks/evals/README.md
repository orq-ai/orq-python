...
| `version_increment`                                                                                                                                                                                                                        | [Optional[models.UpdateEvalVersionIncrement]](../../models/updateevalversionincrement.md)                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                                                                         | N/A                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                            |
...
| `context`                                                                                                                                                                                                                                | [Optional[models.EvaluationContext]](../../models/evaluationcontext.md)                                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                                                                       | The data to grade. When `messages` is present it is the conversation and<br/> `input.user_query` is ignored; `output.response` is appended only when the<br/> conversation carries no assistant turn.                                    |
...
| `messages`                                                                                                                                                                                                                               | List[Dict[str, *Any*]]                                                                                                                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                                                       | The conversation that produced the output. Folds into<br/> `context.messages`.                                                                                                                                                           |
