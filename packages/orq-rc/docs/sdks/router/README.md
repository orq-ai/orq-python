...
| `document`                                                                                            | [models.PostV2RouterOcrDocument](../../models/postv2routerocrdocument.md)                             | :heavy_check_mark:                                                                                    | Document to run OCR on. Can be a DocumentURLChunk or ImageURLChunk.                                   |
