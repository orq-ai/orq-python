...
* [retrieve_file_url](#retrieve_file_url) - Retrieves the file upload url
...
with Orq(
    ...
    res = orq.knowledge.create(key="<key>", model="Fiesta", path="Customer Service/Billing/Refund")
...
**[models.GetOneFileUploadURLResponseBody](../../models/getonefileuploadurlresponsebody.md)**
...
with Orq(
    ...
    res = orq.knowledge.list_datasources(knowledge_id="<id>")
...
with Orq(
    ...
    res = orq.knowledge.list_chunks(knowledge_id="<id>", datasource_id="<id>")
