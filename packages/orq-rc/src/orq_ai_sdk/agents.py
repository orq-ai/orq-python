...
class Agents(BaseSDK):
    ...
    def update(
        ...
        *,
        ...
        model: Optional[
            Union[
                models_updateagentop.UpdateAgentModel,
                models_updateagentop.UpdateAgentModelTypedDict,
            ]
        ] = None,
        fallback_models: Optional[
            Union[
                List[models_updateagentop.UpdateAgentFallbackModels],
                List[models_updateagentop.UpdateAgentFallbackModelsTypedDict],
            ]
        ] = None,
        settings: Optional[
            Union[
