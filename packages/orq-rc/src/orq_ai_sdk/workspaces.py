...
class Workspaces(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.WorkspaceListRequest(
            limit=limit,
    ...
    def get(
        ...
        *,
        ...
        request = models.WorkspaceGetRequest(
            key=key,
        )

        req = self._build_request(
            method="GET",
            path="/v2/workspaces/{key}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetWorkspaceResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIDefaultError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def update(
        ...
        *,
        ...
        settings: Optional[
            Union[
                models.WorkspaceSettingsFields, models.WorkspaceSettingsFieldsTypedDict
            ]
        ] = None,
        metadata: Optional[
            Union[
                models.UpdateWorkspaceRequestMetadata,
                models.UpdateWorkspaceRequestMetadataTypedDict,
            ]
        ] = None,
        ...
        request = models.WorkspaceUpdateRequest(
            ...
            update_workspace_request=models.UpdateWorkspaceRequest(
                ...
                settings=utils.get_pydantic_model(
                    settings, Optional[models.WorkspaceSettingsFields]
                ),
