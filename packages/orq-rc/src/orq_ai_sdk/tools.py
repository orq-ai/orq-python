...
class Tools(BaseSDK):
    ...
    def get_v2_tools_tool_id_versions(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetV2ToolsToolIDVersionsResponseBody:
        r"""List tool versions
        ...
        request = models.GetV2ToolsToolIDVersionsRequest(
            tool_id=tool_id,
            limit=limit,
            starting_after=starting_after,
            ending_before=ending_before,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="get_/v2/tools/{tool_id}/versions",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetV2ToolsToolIDVersionsResponseBody, http_res
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.GetV2ToolsToolIDVersionsToolsResponseBodyData, http_res
            )
            raise models.GetV2ToolsToolIDVersionsToolsResponseBody(
    ...
    def get_v2_tools_tool_id_versions_version_id_(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetV2ToolsToolIDVersionsVersionIDResponseBody:
        r"""Get tool version
        ...
        request = models.GetV2ToolsToolIDVersionsVersionIDRequest(
            tool_id=tool_id,
        ...
        req = self._build_request(
            method="GET",
            path="/v2/tools/{tool_id}/versions/{version_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="get_/v2/tools/{tool_id}/versions/{version_id}",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetV2ToolsToolIDVersionsVersionIDResponseBody, http_res
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.GetV2ToolsToolIDVersionsVersionIDToolsResponseBodyData, http_res
            )
            raise models.GetV2ToolsToolIDVersionsVersionIDToolsResponseBody(
                response_data, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
