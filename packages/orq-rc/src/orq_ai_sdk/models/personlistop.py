...
class PersonListRequestTypedDict(TypedDict):
    limit: NotRequired[int]
    r"""Page size, 1-200. Unset uses the server default."""
    starting_after: NotRequired[str]
    r"""Cursor for forward pagination. Set to the `id` of the last
    item from the previous page.
    """
    ending_before: NotRequired[str]
    r"""Cursor for backward pagination. Set to the `id` of the first
    item from the previous page.
    """
