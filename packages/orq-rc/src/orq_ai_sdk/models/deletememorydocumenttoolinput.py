...
DeleteMemoryDocumentToolInputType = Literal["delete_memory_document",]


class DeleteMemoryDocumentToolInputTypedDict(TypedDict):
    r"""Deletes documents from memory stores"""

    type: DeleteMemoryDocumentToolInputType
...
class DeleteMemoryDocumentToolInput(BaseModel):
    r"""Deletes documents from memory stores"""
