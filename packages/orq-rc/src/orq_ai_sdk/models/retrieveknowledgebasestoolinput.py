...
RetrieveKnowledgeBasesToolInputType = Literal["retrieve_knowledge_bases",]


class RetrieveKnowledgeBasesToolInputTypedDict(TypedDict):
    r"""Lists available knowledge bases"""

    type: RetrieveKnowledgeBasesToolInputType
...
class RetrieveKnowledgeBasesToolInput(BaseModel):
    r"""Lists available knowledge bases"""
