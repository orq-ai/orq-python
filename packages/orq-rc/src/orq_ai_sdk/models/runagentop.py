...
class RunAgentAgentToolInputRunTools(BaseModel):
    ...
    id: Optional[str] = "01KZRN50RQVJVBWHDJ8ED72TCH"
...
RunAgentAgentToolInputRunAgentsRequestRequestBodyType = Literal["function",]


RunAgentAgentToolInputRunAgentsRequestRequestBodySettingsType = Literal["object",]
...
RunAgentAgentToolInputRunAgentsType = Literal["code",]


RunAgentAgentToolInputRunAgentsRequestType = Literal["object",]
r"""The type must be \"object\" """
...
RunAgentAgentToolInputRunType = Literal[
    "string",
    "number",
    "boolean",
]
