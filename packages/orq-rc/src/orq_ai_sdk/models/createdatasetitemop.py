...
class Evaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-02-08T14:09:07.209Z")
    r"""The date and time the item was reviewed"""
...
class Evaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-02-08T14:09:07.208Z")
    r"""The date and time the item was reviewed"""
...
class Evaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-02-08T14:09:07.207Z")
    r"""The date and time the item was reviewed"""
