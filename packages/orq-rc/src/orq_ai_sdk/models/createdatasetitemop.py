...
class Evaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-02-06T05:32:07.648Z")
    r"""The date and time the item was reviewed"""
...
class Evaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-02-06T05:32:07.647Z")
    r"""The date and time the item was reviewed"""
...
class Evaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-02-06T05:32:07.646Z")
    r"""The date and time the item was reviewed"""
