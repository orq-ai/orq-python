...
class ModelCreateOpenAILikeRequestBodyTypedDict(TypedDict):
    api_key: str
    base_url: str
    display_name: str
    model_id: str
...
class ModelCreateOpenAILikeRequestBody(BaseModel):
    api_key: str
...
class ModelCreateOpenAILikeResponseBodyTypedDict(TypedDict):
...
class ModelCreateOpenAILikeResponseBody(BaseModel):
    r"""OpenAI-like model created successfully"""
...
try:
    ModelCreateOpenAILikeResponseBody.model_rebuild()
except NameError:
    pass
