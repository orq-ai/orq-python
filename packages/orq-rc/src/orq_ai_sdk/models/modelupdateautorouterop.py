...
class ModelUpdateAutorouterRequestBodyTypedDict(TypedDict):
...
class ModelUpdateAutorouterRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["economical_model", "key", "profile", "strong_model"])
...
class ModelUpdateAutorouterRequestTypedDict(TypedDict):
    id: str
    r"""The ID of the model"""
    request_body: ModelUpdateAutorouterRequestBodyTypedDict


class ModelUpdateAutorouterRequest(BaseModel):
    id: Annotated[
...
class ModelUpdateAutorouterResponseBodyTypedDict(TypedDict):
    r"""Autorouter model updated successfully"""
...
class ModelUpdateAutorouterResponseBody(BaseModel):
    r"""Autorouter model updated successfully"""
...
try:
    ModelUpdateAutorouterResponseBody.model_rebuild()
except NameError:
    pass
