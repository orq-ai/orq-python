...
class GetAgentResponsePromptTokensDetailsTypedDict(TypedDict):
...
class GetAgentResponsePromptTokensDetails(BaseModel):
...
class GetAgentResponseCompletionTokensDetailsTypedDict(TypedDict):
...
class GetAgentResponseCompletionTokensDetails(BaseModel):
...
class GetAgentResponseUsageTypedDict(TypedDict):
    ...
    prompt_tokens_details: NotRequired[
        Nullable[GetAgentResponsePromptTokensDetailsTypedDict]
    ]
    completion_tokens_details: NotRequired[
        Nullable[GetAgentResponseCompletionTokensDetailsTypedDict]
    ]


class GetAgentResponseUsage(BaseModel):
    r"""Token usage from the agent execution"""
    ...
    prompt_tokens_details: OptionalNullable[GetAgentResponsePromptTokensDetails] = UNSET
...
GetAgentResponseFinishReason = Literal[
    "stop",
    "length",
    "tool_calls",
    "content_filter",
...
GetAgentResponseType = Literal["function",]


class GetAgentResponseFunctionTypedDict(TypedDict):
    name: NotRequired[str]
    arguments: NotRequired[str]


class GetAgentResponseFunction(BaseModel):
...
class GetAgentResponsePendingToolCallsTypedDict(TypedDict):
    id: str
    type: GetAgentResponseType
    function: GetAgentResponseFunctionTypedDict


class GetAgentResponsePendingToolCalls(BaseModel):
    id: str
...
r"""Current status of the agent response"""


class GetAgentResponseTypedDict(TypedDict):
    r"""Response type from the get-response endpoint. Includes a status field indicating the current state of the agent execution."""
    ...
    status: Status
    r"""Current status of the agent response"""
    usage: NotRequired[Nullable[GetAgentResponseUsageTypedDict]]
    r"""Token usage from the agent execution"""
    finish_reason: NotRequired[GetAgentResponseFinishReason]
    r"""The reason why the agent stopped generating"""
    pending_tool_calls: NotRequired[List[GetAgentResponsePendingToolCallsTypedDict]]
    ...
    r"""Error message when status is failed"""
...
class GetAgentResponse(BaseModel):
    ...
    usage: OptionalNullable[GetAgentResponseUsage] = UNSET
    r"""Token usage from the agent execution"""

    finish_reason: Optional[GetAgentResponseFinishReason] = None
    r"""The reason why the agent stopped generating"""

    pending_tool_calls: Optional[List[GetAgentResponsePendingToolCalls]] = None
    r"""Tool calls awaiting user response (when finish_reason is function_call)"""
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["usage", "finish_reason", "pending_tool_calls", "telemetry", "error"]
        )
...
try:
    GetAgentResponse.model_rebuild()
except NameError:
    pass
