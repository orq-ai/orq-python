...
r"""Filter by budget entity type (contact or api_key)"""
...
class ListBudgetsDataTypedDict(TypedDict):
    r"""Budget configuration details (public API response)"""
...
class ListBudgetsData(BaseModel):
    ...
    updated: Optional[datetime] = parse_datetime("2025-12-16T05:40:52.364Z")
    r"""The date and time the resource was last updated"""
