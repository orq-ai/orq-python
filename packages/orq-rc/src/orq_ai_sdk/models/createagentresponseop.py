...
CreateAgentResponseRoleTypedDict = TypeAliasType(
    "CreateAgentResponseRoleTypedDict", Union[RoleUserMessage, RoleToolMessage]
)
r"""Message role (user or tool for continuing executions)"""


CreateAgentResponseRole = TypeAliasType(
    "CreateAgentResponseRole", Union[RoleUserMessage, RoleToolMessage]
)
r"""Message role (user or tool for continuing executions)"""


CreateAgentResponsePublicMessagePartKind = Literal["tool_result",]
...
class A2AMessageTypedDict(TypedDict):
    ...
    role: CreateAgentResponseRoleTypedDict
    r"""Message role (user or tool for continuing executions)"""
...
class CreateAgentResponseThreadTypedDict(TypedDict):
...
class CreateAgentResponseThread(BaseModel):
    r"""Thread information to group related requests"""
...
class CreateAgentResponseRequestBodyTypedDict(TypedDict):
    ...
    r"""Information about the contact making the request. If the contact does not exist, it will be created automatically."""
    thread: NotRequired[CreateAgentResponseThreadTypedDict]
    r"""Thread information to group related requests"""
...
class CreateAgentResponseRequestBody(BaseModel):
    message: A2AMessage
    r"""The A2A message to send to the agent (user input or tool results)"""
    ...
    thread: Optional[CreateAgentResponseThread] = None
    r"""Thread information to group related requests"""
...
class CreateAgentResponseRequestTypedDict(TypedDict):
    agent_key: str
    r"""The key or ID of the agent to invoke"""
    request_body: NotRequired[CreateAgentResponseRequestBodyTypedDict]
...
class CreateAgentResponseRequest(BaseModel):
    ...
    request_body: Annotated[
        Optional[CreateAgentResponseRequestBody],
        FieldMetadata(request=RequestMetadata(media_type="application/json")),
    ] = None


CreateAgentResponseAgentsResponsesRole = Literal[
    "user",
    "agent",
    "tool",
    "system",
...
class CreateAgentResponseUsageTypedDict(TypedDict):
...
class CreateAgentResponseUsage(BaseModel):
    r"""Token usage from the agent execution"""
...
class CreateAgentResponseResponseBodyTypedDict(TypedDict):
    r"""Agent response created successfully"""
    ...
    usage: NotRequired[Nullable[CreateAgentResponseUsageTypedDict]]
    r"""Token usage from the agent execution"""


class CreateAgentResponseResponseBody(BaseModel):
    r"""Agent response created successfully"""
    ...
    usage: OptionalNullable[CreateAgentResponseUsage] = UNSET
    r"""Token usage from the agent execution"""
