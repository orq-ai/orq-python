...
EvalsLocalizationOriginalValueTypedDict = TypeAliasType(
    "EvalsLocalizationOriginalValueTypedDict", Union[float, bool, str]
)


EvalsLocalizationOriginalValue = TypeAliasType(
    "EvalsLocalizationOriginalValue", Union[float, bool, str]
)
...
class EvalsLocalizationValueTypedDict(TypedDict):
    ...
    original_value: NotRequired[Nullable[EvalsLocalizationOriginalValueTypedDict]]
...
class EvalsLocalizationValue(BaseModel):
    ...
    original_value: OptionalNullable[EvalsLocalizationOriginalValue] = UNSET
