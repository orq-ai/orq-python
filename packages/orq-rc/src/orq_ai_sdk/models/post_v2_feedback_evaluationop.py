...
class RequestBody3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-02T01:28:33.027Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-02T01:28:33.026Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-02T01:28:33.025Z")
    r"""The date and time the item was reviewed"""
