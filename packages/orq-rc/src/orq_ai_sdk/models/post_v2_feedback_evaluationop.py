...
class RequestBody3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-05T06:12:43.361Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-05T06:12:43.360Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-05T06:12:43.359Z")
    r"""The date and time the item was reviewed"""
