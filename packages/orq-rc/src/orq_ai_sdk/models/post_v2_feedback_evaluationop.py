...
class RequestBody3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-01T13:49:21.418Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-01T13:49:21.417Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-01T13:49:21.416Z")
    r"""The date and time the item was reviewed"""
