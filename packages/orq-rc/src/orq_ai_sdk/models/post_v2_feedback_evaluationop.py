...
class RequestBody3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-05-20T05:21:18.608Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-05-20T05:21:18.605Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-05-20T05:21:18.604Z")
    r"""The date and time the item was reviewed"""
