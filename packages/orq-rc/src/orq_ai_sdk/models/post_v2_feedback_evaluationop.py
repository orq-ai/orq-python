...
class RequestBody3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-04T09:24:19.886Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-04T09:24:19.885Z")
    r"""The date and time the item was reviewed"""
...
class RequestBody1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-04T09:24:19.884Z")
    r"""The date and time the item was reviewed"""
