...
class GetEvalsEvalsResponseBody(Exception):
    r"""Workspace ID is not found on the request"""

    data: GetEvalsEvalsResponseBodyData

    def __init__(self, data: GetEvalsEvalsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetEvalsEvalsResponseBodyData)
