...
class InvokeEvalEvalsResponseResponseBody(Exception):
    r"""Error running the evaluator"""

    data: InvokeEvalEvalsResponseResponseBodyData

    def __init__(self, data: InvokeEvalEvalsResponseResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, InvokeEvalEvalsResponseResponseBodyData)
...
class InvokeEvalEvalsResponseBody(Exception):
    r"""Workspace ID is not found on the request"""

    data: InvokeEvalEvalsResponseBodyData

    def __init__(self, data: InvokeEvalEvalsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, InvokeEvalEvalsResponseBodyData)
