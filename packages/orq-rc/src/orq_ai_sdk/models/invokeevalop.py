...
from .evaluatorvariablevalue import (
...
class InvokeEvalRequestBodyTypedDict(TypedDict):
    ...
    variables: NotRequired[Dict[str, Nullable[EvaluatorVariableValueTypedDict]]]
    r"""Template variables for evaluator prompt substitution. Request values override evaluator defaults, including for nested arrays and objects."""
...
class InvokeEvalRequestBody(BaseModel):
    ...
    variables: Optional[Dict[str, Nullable[EvaluatorVariableValue]]] = None
    r"""Template variables for evaluator prompt substitution. Request values override evaluator defaults, including for nested arrays and objects."""
...
class InvokeEvalResponseBodyJuryTypedDict(TypedDict):
...
class InvokeEvalResponseBodyJury(BaseModel):
    judges_configured: int
...
class InvokeEvalResponseBodyEvalsValueTypedDict(TypedDict):
    ...
    jury: NotRequired[InvokeEvalResponseBodyJuryTypedDict]
...
class InvokeEvalResponseBodyEvalsValue(BaseModel):
    ...
    jury: Optional[InvokeEvalResponseBodyJury] = None
