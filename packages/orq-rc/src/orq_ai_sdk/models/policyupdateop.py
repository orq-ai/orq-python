...
class PolicyUpdateRequestBodyTypedDict(TypedDict):
...
class PolicyUpdateRequestBody(BaseModel):
...
class PolicyUpdateRequestTypedDict(TypedDict):
    policy_id: str
    r"""The ID of the policy"""
    request_body: PolicyUpdateRequestBodyTypedDict
...
class PolicyUpdateResponseBodyTypedDict(TypedDict):
...
class PolicyUpdateResponseBody(BaseModel):
    r"""Policy updated successfully"""
...
try:
    PolicyUpdateResponseBody.model_rebuild()
except NameError:
    pass
