...
class RetrieveDatapointEvaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-03-02T11:21:38.778Z")
    r"""The date and time the item was reviewed"""
...
class RetrieveDatapointEvaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-03-02T11:21:38.777Z")
    r"""The date and time the item was reviewed"""
...
class RetrieveDatapointResponseBody(BaseModel):
    ...
    updated: Optional[datetime] = parse_datetime("2026-03-02T11:21:22.694Z")
    r"""The date and time the resource was last updated"""
