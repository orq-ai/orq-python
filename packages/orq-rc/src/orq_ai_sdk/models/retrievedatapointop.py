...
RetrieveDatapoint2Format = Literal[
    "mp3",
    "wav",
]
...
RetrieveDatapoint2Detail = Literal[
    "low",
    "high",
    "auto",
]
...
class RetrieveDatapointEvaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-18T11:17:39.114Z")
    r"""The date and time the item was reviewed"""
...
class RetrieveDatapointEvaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-18T11:17:39.113Z")
    r"""The date and time the item was reviewed"""
...
class RetrieveDatapointEvaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-18T11:17:39.112Z")
    r"""The date and time the item was reviewed"""
