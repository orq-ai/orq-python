...
CallSubAgentToolInputType = Literal["call_sub_agent",]


class CallSubAgentToolInputTypedDict(TypedDict):
    r"""Delegates tasks to specialized sub-agents"""

    type: CallSubAgentToolInputType
...
class CallSubAgentToolInput(BaseModel):
    r"""Delegates tasks to specialized sub-agents"""
