...
ListDatasetDatapoints2Format = Literal[
    "mp3",
    "wav",
]
...
ListDatasetDatapoints2Detail = Literal[
    "low",
    "high",
    "auto",
]
...
class ListDatasetDatapointsEvaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-12T05:37:59.735Z")
    r"""The date and time the item was reviewed"""
...
class ListDatasetDatapointsEvaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-12T05:37:59.734Z")
    r"""The date and time the item was reviewed"""
...
class ListDatasetDatapointsEvaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-12T05:37:59.733Z")
    r"""The date and time the item was reviewed"""
...
class ListDatasetDatapointsData(BaseModel):
    ...
    updated: Optional[datetime] = parse_datetime("2025-11-12T05:37:47.766Z")
    r"""The date and time the resource was last updated"""
