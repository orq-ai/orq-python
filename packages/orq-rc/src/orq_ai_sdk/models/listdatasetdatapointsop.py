...
class ListDatasetDatapointsEvaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-10-15T16:02:02.895Z")
    r"""The date and time the item was reviewed"""
...
class ListDatasetDatapointsEvaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-10-15T16:02:02.894Z")
    r"""The date and time the item was reviewed"""
...
class ListDatasetDatapointsData(BaseModel):
    ...
    updated: Optional[datetime] = parse_datetime("2025-10-15T16:01:51.772Z")
    r"""The date and time the resource was last updated"""
