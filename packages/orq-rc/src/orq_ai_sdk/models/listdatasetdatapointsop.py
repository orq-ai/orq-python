...
class ListDatasetDatapointsMessagesGoogleTypedDict(TypedDict):
...
class ListDatasetDatapointsMessagesGoogle(BaseModel):
...
class ListDatasetDatapointsMessagesExtraContentTypedDict(TypedDict):
    r"""Provider-specific extra content for the tool call."""

    google: NotRequired[ListDatasetDatapointsMessagesGoogleTypedDict]


class ListDatasetDatapointsMessagesExtraContent(BaseModel):
    r"""Provider-specific extra content for the tool call."""

    google: Optional[ListDatasetDatapointsMessagesGoogle] = None
...
class ListDatasetDatapointsMessagesToolCallsTypedDict(TypedDict):
    ...
    extra_content: NotRequired[ListDatasetDatapointsMessagesExtraContentTypedDict]
    r"""Provider-specific extra content for the tool call."""
...
class ListDatasetDatapointsMessagesToolCalls(BaseModel):
    ...
    extra_content: Optional[ListDatasetDatapointsMessagesExtraContent] = None
    r"""Provider-specific extra content for the tool call."""
...
class ListDatasetDatapointsEvaluations4(BaseModel):
    ...
    ] = parse_datetime("2026-09-21T06:29:24.076Z")
    r"""Deprecated. The date and time the item was reviewed"""
...
class ListDatasetDatapointsEvaluations2(BaseModel):
    ...
    ] = parse_datetime("2026-09-21T06:29:24.075Z")
    r"""Deprecated. The date and time the item was reviewed"""
