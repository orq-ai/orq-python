...
class RetrieveResponseResponsesResponseBodyData(BaseModel):
    error: APIError


@dataclass(unsafe_hash=True)
class RetrieveResponseResponsesResponseBody(OrqError):
    r"""Response not found."""

    data: RetrieveResponseResponsesResponseBodyData = field(hash=False)

    def __init__(
        self,
        data: RetrieveResponseResponsesResponseBodyData,
