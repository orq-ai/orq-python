...
DeploymentGetConfigPrefixMessagesDeploymentsRequestRequestBodyRole = Literal["tool",]
...
DeploymentGetConfigPrefixMessagesDeploymentsContent = TypeAliasType(
    "DeploymentGetConfigPrefixMessagesDeploymentsContent", Union[str, List[str]]
)
r"""The contents of the tool message."""
...
DeploymentGetConfigPrefixMessagesDeploymentsRequestRole = Literal["assistant",]
...
class PrefixMessagesAssistantMessageTypedDict(TypedDict):
    ...
    r"""The role of the messages author, in this case `assistant`."""
    content: NotRequired[Nullable[DeploymentGetConfigPrefixMessagesContentTypedDict]]
    r"""The contents of the assistant message. Required unless `tool_calls` or `function_call` is specified."""
...
class PrefixMessagesAssistantMessage(BaseModel):
    ...
    content: OptionalNullable[DeploymentGetConfigPrefixMessagesContent] = UNSET
    r"""The contents of the assistant message. Required unless `tool_calls` or `function_call` is specified."""
...
DeploymentGetConfigPrefixMessagesDeploymentsRole = Literal["user",]
...
DeploymentGetConfigPrefixMessagesDeploymentsRequestRequestBody1Role = Literal[
    "developer",
]
...
class PrefixMessagesDeveloperMessageTypedDict(TypedDict):
    role: DeploymentGetConfigPrefixMessagesDeploymentsRequestRequestBody1Role
    r"""The role of the messages author, in this case  `developer`."""
    content: str
