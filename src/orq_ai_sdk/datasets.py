...
class Datasets(BaseSDK):
    ...
    def create_datapoint(
        ...
        *,
        ...
        :param messages: The prompt template messages
    ...
    def create_datapoints(
        ...
        *,
        ...
        request = models.BulkCreateDatapointsRequest(
            dataset_id=dataset_id,
            request_body=models.BulkCreateDatapointsRequestBody(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.BulkCreateDatapointsRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
