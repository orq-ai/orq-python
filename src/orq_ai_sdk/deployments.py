...
class Deployments(BaseSDK):
    def invoke(
        ...
        *,
        ...
        thread: Optional[
            Union[
                models.InvokeDeploymentRequestThread,
                models.InvokeDeploymentRequestThreadTypedDict,
            ]
        ] = None,
        ...
        request = models.InvokeDeploymentRequest(
            ...
            thread=utils.get_pydantic_model(
                thread, Optional[models.InvokeDeploymentRequestThread]
            ),
            ...
            hook_ctx=HookContext(
                ...
                extensions={
                    ...
                    "x-code-samples": [
                        {
                            "lang": "TypeScript",
                            "source": "import { Orq } from '@orq-ai/node';\n\nconst orq = new Orq({ apiKey: process.env.ORQ_API_KEY ?? '' });\nconst stream = await orq.deployments.stream({\n  key: 'customer-support',\n  inputs: { question: 'What is your refund policy?' },\n});\nfor await (const event of stream) {\n  console.log(event);\n}",
                        }
                    ],
                },
            ),
