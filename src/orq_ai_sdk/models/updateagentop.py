...
UpdateAgentModelConfigurationIDTypedDict = TypeAliasType(
    "UpdateAgentModelConfigurationIDTypedDict", Union[UpdateAgentID1, str]
)


UpdateAgentModelConfigurationID = TypeAliasType(
    "UpdateAgentModelConfigurationID", Union[UpdateAgentID1, str]
)
...
class ModelConfigurationGuardrailsTypedDict(TypedDict):
    id: UpdateAgentModelConfigurationIDTypedDict
    execute_on: ModelConfigurationExecuteOn
    r"""Determines whether the guardrail runs on the input (user message) or output (model response)."""


class ModelConfigurationGuardrails(BaseModel):
    id: UpdateAgentModelConfigurationID

    execute_on: ModelConfigurationExecuteOn
    r"""Determines whether the guardrail runs on the input (user message) or output (model response)."""


ModelConfigurationPluginsTypedDict = TypeAliasType(
...
ModelConfigurationPlugins = TypeAliasType(
...
UpdateAgentModelConfigurationAgentsType = Literal["ephemeral",]
r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""


UpdateAgentModelConfigurationTTL = Literal[
    "5m",
    "1h",
]
...
class UpdateAgentModelConfigurationCacheControlTypedDict(TypedDict):
    ...
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""
    ttl: NotRequired[UpdateAgentModelConfigurationTTL]
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentModelConfigurationCacheControl(BaseModel):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentModelConfigurationAgentsType
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""

    ttl: Optional[UpdateAgentModelConfigurationTTL] = "5m"
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class ModelConfigurationParametersTypedDict(TypedDict):
    ...
    r"""Timeout configuration to apply to the request. If the request exceeds the timeout, it will be retried or fallback to the next model if configured."""
    cache_control: NotRequired[UpdateAgentModelConfigurationCacheControlTypedDict]
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
...
class ModelConfigurationParameters(BaseModel):
    ...
    cache_control: Optional[UpdateAgentModelConfigurationCacheControl] = None
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
...
UpdateAgentFallbackModelConfigurationPluginsTypedDict = TypeAliasType(
...
UpdateAgentFallbackModelConfigurationPlugins = TypeAliasType(
...
UpdateAgentFallbackModelConfigurationAgentsType = Literal["ephemeral",]
r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""


UpdateAgentFallbackModelConfigurationTTL = Literal[
    "5m",
    "1h",
]
r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentFallbackModelConfigurationCacheControlTypedDict(TypedDict):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentFallbackModelConfigurationAgentsType
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""
    ttl: NotRequired[UpdateAgentFallbackModelConfigurationTTL]
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentFallbackModelConfigurationCacheControl(BaseModel):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentFallbackModelConfigurationAgentsType
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""

    ttl: Optional[UpdateAgentFallbackModelConfigurationTTL] = "5m"
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentFallbackModelConfigurationParametersTypedDict(TypedDict):
    ...
    r"""A list of guardrails to apply to the request."""
    plugins: NotRequired[List[UpdateAgentFallbackModelConfigurationPluginsTypedDict]]
    r"""Request-scoped transforms applied to the text exchanged with the model. Supports `pii_redaction`, which replaces PII with placeholders before the provider sees it and restores the original values in the response, and `response_healing`, which repairs malformed JSON in non-streaming output."""
    ...
    cache_control: NotRequired[
        UpdateAgentFallbackModelConfigurationCacheControlTypedDict
    ]
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
    prompt_cache_key: NotRequired[str]
    r"""Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the legacy `user` field for prompt caching."""
...
class UpdateAgentFallbackModelConfigurationParameters(BaseModel):
    ...
    plugins: Optional[List[UpdateAgentFallbackModelConfigurationPlugins]] = None
    r"""Request-scoped transforms applied to the text exchanged with the model. Supports `pii_redaction`, which replaces PII with placeholders before the provider sees it and restores the original values in the response, and `response_healing`, which repairs malformed JSON in non-streaming output."""
    ...
    cache_control: Optional[UpdateAgentFallbackModelConfigurationCacheControl] = None
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
...
UpdateAgentPluginsTypedDict = TypeAliasType(
...
UpdateAgentPlugins = TypeAliasType(
    "UpdateAgentPlugins",
    Union[
        ResponseHealingPlugin,
        PIIRedactionPluginAuto,
...
UpdateAgentAgentsType = Literal["exact_match",]
...
UpdateAgentAgentsResponseType = Literal["ephemeral",]
r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""


UpdateAgentTTL = Literal[
    "5m",
    "1h",
]
r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentCacheControlTypedDict(TypedDict):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentAgentsResponseType
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""
    ttl: NotRequired[UpdateAgentTTL]
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentCacheControl(BaseModel):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentAgentsResponseType
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""

    ttl: Optional[UpdateAgentTTL] = "5m"
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentParametersTypedDict(TypedDict):
    ...
    r"""A list of guardrails to apply to the request."""
    plugins: NotRequired[List[UpdateAgentPluginsTypedDict]]
    r"""Request-scoped transforms applied to the text exchanged with the model. Supports `pii_redaction`, which replaces PII with placeholders before the provider sees it and restores the original values in the response, and `response_healing`, which repairs malformed JSON in non-streaming output."""
    ...
    r"""Timeout configuration to apply to the request. If the request exceeds the timeout, it will be retried or fallback to the next model if configured."""
    cache_control: NotRequired[UpdateAgentCacheControlTypedDict]
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
    prompt_cache_key: NotRequired[str]
    r"""Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the legacy `user` field for prompt caching."""
...
class UpdateAgentParameters(BaseModel):
    ...
    plugins: Optional[List[UpdateAgentPlugins]] = None
    r"""Request-scoped transforms applied to the text exchanged with the model. Supports `pii_redaction`, which replaces PII with placeholders before the provider sees it and restores the original values in the response, and `response_healing`, which repairs malformed JSON in non-streaming output."""
    ...
    cache_control: Optional[UpdateAgentCacheControl] = None
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
...
UpdateAgentFallbackModelConfigurationAgentsPluginsTypedDict = TypeAliasType(
...
UpdateAgentFallbackModelConfigurationAgentsPlugins = TypeAliasType(
...
UpdateAgentFallbackModelConfigurationAgentsResponseType = Literal["exact_match",]
...
UpdateAgentFallbackModelConfigurationAgentsResponse200Type = Literal["ephemeral",]
r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""


UpdateAgentFallbackModelConfigurationAgentsTTL = Literal[
    "5m",
    "1h",
]
r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentFallbackModelConfigurationAgentsCacheControlTypedDict(TypedDict):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentFallbackModelConfigurationAgentsResponse200Type
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""
    ttl: NotRequired[UpdateAgentFallbackModelConfigurationAgentsTTL]
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentFallbackModelConfigurationAgentsCacheControl(BaseModel):
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""

    type: UpdateAgentFallbackModelConfigurationAgentsResponse200Type
    r"""Create a cache control breakpoint at this content block. Accepts only the value \"ephemeral\"."""

    ttl: Optional[UpdateAgentFallbackModelConfigurationAgentsTTL] = "5m"
    r"""The time-to-live for the cache control breakpoint. This may be one of the following values:
...
class UpdateAgentFallbackModelConfigurationAgentsParametersTypedDict(TypedDict):
    ...
    r"""A list of guardrails to apply to the request."""
    plugins: NotRequired[
        List[UpdateAgentFallbackModelConfigurationAgentsPluginsTypedDict]
    ]
    r"""Request-scoped transforms applied to the text exchanged with the model. Supports `pii_redaction`, which replaces PII with placeholders before the provider sees it and restores the original values in the response, and `response_healing`, which repairs malformed JSON in non-streaming output."""
    fallbacks: NotRequired[
    ...
    r"""Timeout configuration to apply to the request. If the request exceeds the timeout, it will be retried or fallback to the next model if configured."""
    cache_control: NotRequired[
        UpdateAgentFallbackModelConfigurationAgentsCacheControlTypedDict
    ]
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
    prompt_cache_key: NotRequired[str]
    r"""Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the legacy `user` field for prompt caching."""
...
class UpdateAgentFallbackModelConfigurationAgentsParameters(BaseModel):
    ...
    plugins: Optional[List[UpdateAgentFallbackModelConfigurationAgentsPlugins]] = None
    r"""Request-scoped transforms applied to the text exchanged with the model. Supports `pii_redaction`, which replaces PII with placeholders before the provider sees it and restores the original values in the response, and `response_healing`, which repairs malformed JSON in non-streaming output."""
    ...
    cache_control: Optional[UpdateAgentFallbackModelConfigurationAgentsCacheControl] = (
        None
    )
    r"""Provider-level prompt caching configuration applied to the request. Creates a cache control breakpoint covering the request content. Only supported by `Anthropic` Claude models."""
...
class UpdateAgentModel(BaseModel):
    ...
    parameters: OptionalNullable[UpdateAgentParameters] = UNSET
    r"""Model behavior parameters (snake_case) stored as part of the agent configuration. These become the default parameters used when the agent is executed. Commonly used: temperature (0-1, controls randomness), max_completion_tokens (response length), top_p (nucleus sampling). Advanced: frequency_penalty, presence_penalty, response_format (JSON/structured output), reasoning_effort (for o1/thinking models), seed (reproducibility), stop sequences. Model-specific support varies. Runtime parameters in agent execution requests can override these defaults."""
