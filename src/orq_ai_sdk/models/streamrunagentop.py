...
StreamRunAgentPublicMessagePartAgentsKind = Literal["tool_result",]
...
StreamRunAgentPublicMessagePartKind = Literal["file",]
...
class AgentToolInputRunTools(BaseModel):
    ...
    id: Optional[str] = "01KAXCAFXPAJH37DSJ4N3WQ00C"
...
StreamRunAgentDataAgentsResponseParts = Annotated[
    Union[
...
StreamRunAgentDataAgentsParts = Annotated[
    Union[
        Annotated[TextPart, Tag("text")],
        Annotated[DataPart, Tag("data")],
        Annotated[FilePart, Tag("file")],
...
StreamRunAgentDataParts = Annotated[
    Union[
        Annotated[TextPart, Tag("text")],
        Annotated[DataPart, Tag("data")],
        Annotated[FilePart, Tag("file")],
