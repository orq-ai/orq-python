...
class CancelBatchRequestTypedDict(TypedDict):
    batch_id: str
...
CancelBatchObject = Literal["batch"]
r"""The object type, which is always batch."""


class CancelBatchErrorsTypedDict(TypedDict):
    r"""Errors associated with the batch."""


class CancelBatchErrors(BaseModel):
    r"""Errors associated with the batch."""


class CancelBatchRequestCountsTypedDict(TypedDict):
...
class CancelBatchRequestCounts(BaseModel):
    r"""The request counts for different statuses within the batch."""
...
class CancelBatchResponseBodyTypedDict(TypedDict):
    ...
    errors: CancelBatchErrorsTypedDict
    r"""Errors associated with the batch."""
    input_file_id: str
    ...
    request_counts: CancelBatchRequestCountsTypedDict
    r"""The request counts for different statuses within the batch."""
...
class CancelBatchResponseBody(BaseModel):
    r"""A list of paginated Batch objects."""
    ...
    request_counts: CancelBatchRequestCounts
    r"""The request counts for different statuses within the batch."""
