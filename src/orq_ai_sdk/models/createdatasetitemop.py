...
CreateDatasetItem2Format = Literal[
    "mp3",
    "wav",
]
...
CreateDatasetItem2Detail = Literal[
    "low",
    "high",
    "auto",
]
...
CreateDatasetItem2DatasetsFormat = Literal[
    "mp3",
    "wav",
]
r"""The format of the encoded audio data. Currently supports `wav` and `mp3`."""
...
CreateDatasetItem2DatasetsDetail = Literal[
    "low",
    "high",
    "auto",
]
...
class Evaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-03T20:22:38.348Z")
    r"""The date and time the item was reviewed"""
...
class Evaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-03T20:22:38.347Z")
    r"""The date and time the item was reviewed"""
...
class Evaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-03T20:22:38.346Z")
    r"""The date and time the item was reviewed"""
