...
ParseChunkingRequestChunkingRequestRequestBody7ReturnType = Literal[
    "chunks",
    "texts",
]
...
LateChunker = Literal["late",]


class LateChunkerStrategyTypedDict(TypedDict):
    r"""Splits text after preserving the full-document context in its embeddings. Best for retrieval workflows where each chunk should retain information from the surrounding document."""
...
class LateChunkerStrategy(BaseModel):
    r"""Splits text after preserving the full-document context in its embeddings. Best for retrieval workflows where each chunk should retain information from the surrounding document."""
    ...
    return_type: Optional[ParseChunkingRequestChunkingRequestRequestBody7ReturnType] = (
        "chunks"
    )
    r"""Return format: chunks (with metadata) or texts (plain strings)"""
...
ParseChunkingRequest = Annotated[
    Union[
        ...
        Annotated[LateChunkerStrategy, Tag("late")],
    ],
