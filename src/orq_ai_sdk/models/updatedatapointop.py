...
class UpdateDatapointEvaluations4(BaseModel):
    ...
    ] = parse_datetime("2026-09-15T10:05:03.684Z")
    r"""Deprecated. The date and time the item was reviewed"""
...
class UpdateDatapointEvaluations3(BaseModel):
    ...
    ] = parse_datetime("2026-09-15T10:05:03.683Z")
    r"""Deprecated. The date and time the item was reviewed"""
...
class UpdateDatapointEvaluations1(BaseModel):
    ...
    ] = parse_datetime("2026-09-15T10:05:03.682Z")
    r"""Deprecated. The date and time the item was reviewed"""
...
class UpdateDatapointResponseBody(BaseModel):
    ...
    updated: Optional[datetime] = parse_datetime("2026-09-15T10:04:55.455Z")
    r"""The date and time the resource was last updated"""
