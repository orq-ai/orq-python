...
class UpdateDatapointEvaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-22T22:56:02.016Z")
    r"""The date and time the item was reviewed"""
...
class UpdateDatapointEvaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2025-11-22T22:56:02.015Z")
    r"""The date and time the item was reviewed"""
...
class UpdateDatapointResponseBody(BaseModel):
    ...
    updated: Optional[datetime] = parse_datetime("2025-11-22T22:55:48.623Z")
    r"""The date and time the resource was last updated"""
