...
QueryMemoryStoreToolInputType = Literal["query_memory_store",]


class QueryMemoryStoreToolInputTypedDict(TypedDict):
    r"""Queries agent memory stores for context"""

    type: QueryMemoryStoreToolInputType
...
class QueryMemoryStoreToolInput(BaseModel):
    r"""Queries agent memory stores for context"""
