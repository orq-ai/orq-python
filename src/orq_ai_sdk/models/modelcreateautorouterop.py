...
class ModelCreateAutorouterRequestBodyTypedDict(TypedDict):
...
class ModelCreateAutorouterRequestBody(BaseModel):
    economical_model: str
...
class ModelCreateAutorouterResponseBodyTypedDict(TypedDict):
    r"""Autorouter model created successfully"""
...
class ModelCreateAutorouterResponseBody(BaseModel):
    r"""Autorouter model created successfully"""
...
try:
    ModelCreateAutorouterResponseBody.model_rebuild()
except NameError:
    pass
