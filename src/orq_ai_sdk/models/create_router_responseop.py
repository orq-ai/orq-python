...
class CreateRouterResponseRequestBodyTypedDict(TypedDict):
    ...
    cache: NotRequired[CacheConfigTypedDict]
    ...
    r"""Integration ID used to resolve provider credentials for this request."""
    limits: NotRequired[ResponseExecutionLimitsTypedDict]
    load_balancer: NotRequired[LoadBalancerConfigTypedDict]
    ...
    timeout: NotRequired[TimeoutConfigTypedDict]
