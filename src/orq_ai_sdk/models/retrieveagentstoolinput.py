...
RetrieveAgentsToolInputType = Literal["retrieve_agents",]


class RetrieveAgentsToolInputTypedDict(TypedDict):
    r"""Retrieves available agents in the system"""

    type: RetrieveAgentsToolInputType
...
class RetrieveAgentsToolInput(BaseModel):
    r"""Retrieves available agents in the system"""
