...
RetrieveMemoryStoresToolInputType = Literal["retrieve_memory_stores",]


class RetrieveMemoryStoresToolInputTypedDict(TypedDict):
    r"""Lists available memory stores"""

    type: RetrieveMemoryStoresToolInputType
...
class RetrieveMemoryStoresToolInput(BaseModel):
    r"""Lists available memory stores"""
