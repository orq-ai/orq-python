...
class GetV2EvaluatorsIDVersionsRequestTypedDict(TypedDict):
    id: str
...
class GetV2EvaluatorsIDVersionsRequest(BaseModel):
    id: Annotated[
...
GetV2EvaluatorsIDVersionsObject = Literal["list",]


class GetV2EvaluatorsIDVersionsDataTypedDict(TypedDict):
    id: str
    created_at: str
    updated_at: str
    updated_by_id: str
...
class GetV2EvaluatorsIDVersionsData(BaseModel):
...
class GetV2EvaluatorsIDVersionsResponseBodyTypedDict(TypedDict):
    ...
    data: List[GetV2EvaluatorsIDVersionsDataTypedDict]
    has_more: bool


class GetV2EvaluatorsIDVersionsResponseBody(BaseModel):
    r"""Evaluator versions retrieved"""
