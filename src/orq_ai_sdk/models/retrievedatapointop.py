...
class RetrieveDatapointEvaluations3(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-04T22:50:47.122Z")
    r"""The date and time the item was reviewed"""
...
class RetrieveDatapointEvaluations2(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-04T22:50:47.121Z")
    r"""The date and time the item was reviewed"""
...
class RetrieveDatapointEvaluations1(BaseModel):
    ...
    reviewed_at: Optional[datetime] = parse_datetime("2026-06-04T22:50:47.120Z")
    r"""The date and time the item was reviewed"""
